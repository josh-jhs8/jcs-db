...
void serialise_row(Row* source, void* dest)
{
...
void deserialise_row(void* source, Row* dest)
{
...
Pager* pager_open(const char* filename)
{
    int fd = open(filename,
                ...
                S_IWUSR | S_IRUSR); // User has read and write permissions
...
PrepareResult prepate_insert(InputBuffer* input_buffer, Statement* statement)
{
...
PrepareResult prepare_statement(InputBuffer* input_buffer, Statement* statement) 
{
    ...
    {
        return prepate_insert(input_buffer, statement);
    }
...
ExecuteResult execute_insert(Statement* statement, Table* table)
{
    ...
    serialise_row(row_to_insert, cursor_value(cursor));
    table->num_rows += 1;
    free(cursor);
